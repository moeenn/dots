...
complete -c git-apply -l index --description 'Apply the patch to both the index and the working tree (or merely check that …'
complete -c git-apply -l cached --description 'Apply the patch to just the index, without touching the working tree.'
