...
complete -c clang -s c --description 'Run all of the above, plus the assembler, generating a target â.'
...
complete -c clang -o fpascal-strings --description 'Enable support for Pascal-style strings with âpfooâ.'
...
complete -c clang -o flax-vector-conversions -o flax-vector-conversions -o fno-lax-vector-conversions --description 'Allow loose type checking rules for implicit vector conversions.'
complete -c clang -o fblocks --description 'Enable the âBlocksâ language feature.'
...
complete -c clang -o target --description 'Specify the architecture to build for.'
...
complete -c clang -o mcpu -o mtune --description 'Acts as an alias for \\%--print-supported-cpus.'
...
complete -c clang -o feliminate-unused-debug-types --description 'By default, Clang does not emit type information for types that are defined b…'
...
complete -c clang -o print-libgcc-file-name --description 'Print the library path for the currently used compiler runtime library (âli…'
...
complete -c clang -o nobuiltininc --description 'Do not search clangâs builtin directory for include files.'
complete -c clang -o object_path_lto --description 'ld64 linker not to delete the temporary object file generated during Link Tim…'
