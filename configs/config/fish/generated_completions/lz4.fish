...
complete -c lz4 -o 'b#' --description 'Benchmark mode, using # compression level.'
complete -c lz4 -l list --description 'List information about . lz4 files.'
complete -c lz4 -s '#' --description 'Compression level, with # being any value from 1 to 12.'
complete -c lz4 -l fast --description 'Switch to ultra-fast compression levels.'
complete -c lz4 -l best --description 'Set highest compression level.  Same as -12.'
complete -c lz4 -l favor-decSpeed --description 'Generate compressed data optimized for decompression speed.'
complete -c lz4 -s D --description 'Compress, decompress or benchmark using dictionary dictionaryName.'
...
complete -c lz4 -o BI --description 'Produce independent blocks (default) .'
complete -c lz4 -o BD --description 'Blocks depend on predecessors (improves compression ratio, more noticeable on…'
