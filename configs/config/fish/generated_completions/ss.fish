...
complete -c ss -s O -l oneline --description 'Print each socket\'s data on a single line.'
...
complete -c ss -l tos --description 'Show ToS and priority information.  Below fields may appear: . RS . P.'
complete -c ss -l cgroup --description 'Show cgroup information.  Below fields may appear: . RS . P.'
...
complete -c ss -s E -l events --description 'Continually display sockets as they are destroyed.'
...
complete -c ss -l xdp --description 'Display XDP sockets (alias for -f xdp).'
complete -c ss -l inet-sockopt --description 'Display inet socket options.'
