...
complete -c find -o maxdepth --description 'would prevent this).'
...
complete -c find -o fstype --description 'predicate and specify a filesystem type FOO which is not known (that is, pres…'
...
complete -c find -o gid --description '.'
complete -c find -o inum --description '.'
complete -c find -o links --description '.'
complete -c find -o size --description '.'
complete -c find -o uid --description 'and.'
complete -c find -o used --description 'as +n for greater than n ,.'
complete -c find -s n --description 'for less than n , n for exactly n .  Supported tests:.'
...
complete -c find -o a+r --description 'have at least one write bit set ( -perm /222 or.'
