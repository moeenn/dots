...
complete -c cmake -l no-warn-unused-cli --description 'Donât warn about command line options.'
complete -c cmake -l check-system-vars --description 'Find problems with variable usage in system files.'
complete -c cmake -l profiling-output --description 'Used in conjuction with --profiling-format to output to a given path.'
