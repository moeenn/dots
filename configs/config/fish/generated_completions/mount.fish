...
complete -c mount -l source --description 'options to avoid ambiguous interpretation of the given argument.'
complete -c mount -l fstab --description 'command-line option (see below for more details).'
complete -c mount -s F --description 'option will make mount fork, so that the filesystems are mounted in parallel.'
complete -c mount -l options-mode --description 'command-line option.'
complete -c mount -l options-source-force --description 'to always read configuration from fstab .'
...
complete -c mount -s N -l namespace --description 'Perform the mount operation in the mount namespace specified by ns.'
...
complete -c mount -l target-prefix --description 'Prepend the specified directory to all mount targets.'
...
complete -c mount -l rw -l read-write --description 'Mount the filesystem read/write.'
...
complete -c mount -o signer -o noattr -o binary -o outform -o out --description 'mount -o verity. hashdevice=/tmp/etc. hash,verity. roothash=<hash>,\\ verity.'
