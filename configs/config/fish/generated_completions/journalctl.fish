...
complete -c journalctl -s q -l quiet --description 'Suppresses all informational messages (i. e.  "-- Journal begins at .'
...
complete -c journalctl -l case-sensitive --description 'Make pattern matching case sensitive or case insensitive.'
...
complete -c journalctl -l image --description 'Takes a path to a disk image file or block device node.'
