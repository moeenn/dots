...
complete -c git-log -o 'L<start>' -o 'L:<funcname>:<file>' --description 'Trace the evolution of the line range given by <start>,<end>, or by the funct…'
...
complete -c git-log -l abbrev-commit --description 'Instead of showing the full 40-byte hexadecimal commit object name, show a pr…'
...
complete -c git-log -s L --description 'range, if any, otherwise from the start of file.'
...
complete -c git-log -s c --description '.'
complete -c git-log -l cc --description '.'
complete -c git-log -l combined-all-paths --description '.'
complete -c git-log -s m --description '.'
...
complete -c git-log -s t --description '.'
...
complete -c git-log -o 'I<regex>' -l ignore-matching-lines --description '.'
