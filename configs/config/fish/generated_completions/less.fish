...
complete -c less -l mouse --description 'Enables mouse input: scrolling the mouse wheel down moves forward in the file…'
complete -c less -l MOUSE --description 'Like --mouse, except the direction scrolled  on mouse wheel movement is rever…'
complete -c less -l no-keypad --description 'Disables sending the keypad initialization and deinitialization strings to th…'
complete -c less -l no-histdups --description 'This option changes the behavior so that if a search string or file name is t…'
complete -c less -l rscroll --description 'This option changes the character used to mark truncated lines.'
complete -c less -l save-marks --description 'Save marks in the history file, so marks are retained across different invoca…'
complete -c less -l use-backslash --description 'This option changes the interpretations of options which follow this one.'
complete -c less -l wheel-lines --description 'Set the number of lines to scroll when the mouse wheel is scrolled and the --…'
