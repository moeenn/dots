...
complete -c sudo -s D --description 'Run the command in the specified directory instead of the current working dir…'
...
complete -c sudo -s R --description 'Change to the specified root directory (see chroot 8 ) before running the com…'
