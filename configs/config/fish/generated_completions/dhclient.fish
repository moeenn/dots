...
complete -c dhclient -s e --description 'Define additional environment variables for the environment where  dhclient-s…'
...
complete -c dhclient -l decline-wait-time --description 'Specify the time (in seconds) that an IPv4 client should wait after declining…'
...
complete -c dhclient -l address-prefix-len --description 'Specify the length of the prefix for IPv6 addresses.'
...
complete -c dhclient -l prefix-len-hint --description 'When used in conjunction with -P, it directs the client to use the given leng…'
