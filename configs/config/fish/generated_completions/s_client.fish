...
complete -c s_client -o nbio_test --description 'Tests nonblocking I/O.'
complete -c s_client -o nbio --description 'Turns on nonblocking I/O.'
...
complete -c s_client -o sctp_label_bug --description 'Use the incorrect behaviour of older OpenSSL implementations when computing e…'
...
complete -c s_client -o bugs --description 'There are several known bugs in \\s-1SSL\\s0 and \\s-1TLS\\s0 implementations.'
