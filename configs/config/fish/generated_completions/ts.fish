...
complete -c ts -o data --description 'The data file for which the timestamp request needs to be created.'
...
complete -c ts -o in --description 'This option specifies a previously created timestamp request in \\s-1DER\\s0 fo…'
...
complete -c ts -o queryfile --description 'The name of the file containing a \\s-1DER\\s0 encoded timestamp request.'
...
complete -c ts -o token_out --description 'The output is a timestamp token (ContentInfo) instead of timestamp response (…'
