...
complete -c net -l recursive --description 'Traverse a directory hierarchy.'
complete -c net -l continue --description 'Continue traversing a directory hierarchy in case conversion of one file fail…'
complete -c net -l follow-symlinks --description 'Follow symlinks encountered while traversing a directory.'
