...
complete -c lspci -s P --description 'Identify PCI devices by path through each bridge, instead of by bus number.'
complete -c lspci -o PP --description 'Identify PCI devices by path through each bridge, showing the bus number as w…'
