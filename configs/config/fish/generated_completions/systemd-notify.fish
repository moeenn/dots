...
complete -c systemd-notify -l pid --description 'Inform the service manager about the main PID of the daemon.'
...
complete -c systemd-notify -l no-block --description 'Do not synchronously wait for the requested operation to finish.'
