...
complete -c hp-setup -o 'd<device>' -l device -l qt4 --description 'Remove printers or faxes instead of setting-up:.'
...
complete -c hp-setup -o 'l<level>' -l logging --description '<level>: none, info*, error, warn, debug (*default) Run in debug mode:.'
