...
complete -c dgst -o list --description 'Prints out a list of supported message digests.'
...
complete -c dgst -s r --description 'Output the digest in the \\*(L"coreutils\\*(R" format, including newlines.'
...
complete -c dgst -o writerand --description 'Writes random data to the specified file upon exit.'
