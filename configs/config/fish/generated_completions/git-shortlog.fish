...
complete -c git-shortlog -l group --description 'Group commits based on <type>.'
complete -c git-shortlog -s c -l committer --description 'This is an alias for --group=committer.'
